---
title: "Writing Your Thesis with UHHthesis"
output: rmarkdown::html_vignette
description: >
  Complete reference for YAML configuration, R Markdown syntax, figures, tables,
  equations, citations, cross-references, and troubleshooting for the UHHthesis package.
vignette: >
  %\VignetteIndexEntry{Writing Your Thesis with UHHthesis}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

This reference covers everything you need once your thesis project is set up. For installation and project creation, see [Getting Started](uhhthesis-getting-started-en.html).
...
2. [R Markdown Basics](#2-r-markdown-basics)
3. [Figures](#3-figures)
4. [Tables](#4-tables)
5. [Mathematical Equations and Chemical Formulas](#5-mathematical-equations-and-chemical-formulas)
6. [Citations and Bibliography](#6-citations-and-bibliography)
7. [Cross-References Summary](#7-cross-references-summary)
...
For figure and table-specific options, see [Figures](#3-figures) and [Tables](#4-tables).
