...
Externe Grafiken (z.B. Karten) werden mit `knitr::include_graphics()` eingebettet. Die Bildunterschrift wird über `fig.cap` festgelegt, die Breite über `out.width`:
