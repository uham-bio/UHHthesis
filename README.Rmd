...
> UPDATE: **Looking for the Quarto version?** Want to combine R with Python or Julia, work in Positron, VS Code, or another editor of your choice, and use the latest publishing framework? Then check out our latest tool [quarto-UHHthesis](https://github.com/uham-bio/quarto-UHHthesis) — the recommended choice for all new thesis projects.
...
- **LaTeX** for PDF output — the easiest option is [TinyTeX](https://yihui.org/tinytex/):
...
Full documentation, tutorials, and the template gallery are available on the **[UHHthesis website](https://uham-bio.github.io/UHHthesis/)**.
